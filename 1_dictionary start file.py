...
phone = phonebook.get("chris", "999")  # second peram is a default
print(phone)
...
remove = phonebook.pop("Chris", "default")
print(remove)
print(phonebook)
...
a = phonebook.popitem() #pops the last item
